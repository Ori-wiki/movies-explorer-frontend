      ...
      <article className='student__info'>
        <div className='student__info-container'>
          ...
          <p className='student__bio'>
            ...
            начинал изучать HTML. Мне сразу это понравилось. Мне сразу это
            понравилось. В итоге я решил поступить в Яндекс.Практикум и
            целенаправленно развиваться в профессии.
          </p>
